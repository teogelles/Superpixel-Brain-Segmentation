...
%% Initialization
[X, y, nExamples] = load_ibsr('/acmi/chris13/ibsr/images/', '/acmi/chris13/ibsr/segmentations/'); %Load Current IBSR files
...
decode(w,examples,testing,nRows,nCols,origY, 'SGM Decoding', ZmaskFlat);   
if pauses
    fprintf('(paused)\n');
    pause
end
