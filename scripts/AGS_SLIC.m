%% SLIC, A MATLAB implementation
% The following code is a MATLAB implementation of the SLIC
...
% Implemented by Andrew Gilchrist-Scott

function newImage = SLIC(imageFilepath, numSuperPixels)
    
    [X,map] = imread(imageFilepath);
