...
function slicFeatures = condor_runSLICExact(imageType, imageNum, ...
                                shapeParam, numIters)
    ...
    if (isdeployed)
        ...
        shapeParam = str2num(shapeParam);
        numIters = str2num(numIters);
    end
    ...
    if (exist(slicAddr, 'file') && exist(borderAddr, 'file') && ...
        ...
        [labels border centerInfo] = condor_SLIC_3DExact(X, shapeParam, numIters);
